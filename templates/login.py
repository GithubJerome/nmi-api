...
class LoginEmail():
    ...
    # INITIALIZE
    def __init__(self):
        """The Constructor LoginEmail class"""
    ...
    def message_temp(self, username, message, url):
        """Message Temporary"""
                ...
                <table style="width:100%;max-width:600px;border:1px solid #dbdbdb;border-radius:5px;background:#fff;padding:0px;margin:0 auto 0px auto" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        ...
                        <td style="padding:30px 30px 30px 30px">
                            <p style="font-family:arial,sans-serif;color:#474747;font-weight:normal;font-size:14px;margin:0;padding:0 0 0 0;text-align:left;line-height:1.5">Hi """+username+""",<br><br>We noticed a new login to NMI and wanted to make sure it was you.</p>"""
        ...
        email_temp += """<a href='"""+str(url)+'/account/settings'+"""'>"""+str(url)+"""/account/settings</a></p>"""
        email_temp += """
