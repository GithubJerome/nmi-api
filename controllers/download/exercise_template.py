...
class ExerciseTemplate(Common):
    """Class for ExerciseTemplate"""

    # INITIALIZE
    def __init__(self):
        """The Constructor for ExerciseTemplate class"""

        self.config = ConfigParser()
        self.config.read("config/config.cfg")
        super(ExerciseTemplate, self).__init__()

    def exercise_template(self):
        """
        This API is for Exercise Question Template
        ---
        tags:
          - Download
        produces:
                        ...
                        for exercise in subsection['children']:
                            ...
                            if db_skills:
                                ...
                                for skill in db_skills:
                                    ...
                                    new_skill['subskills'] = [sskll['subskill'] for sskll in skill['sskill']]
