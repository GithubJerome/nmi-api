...
class AddCourseStudent(Common, ShaSecurity):
    """Class for AddCourseStudent"""

    # INITIALIZE
    def __init__(self):
        """The Constructor for AddCourseStudent class"""

        self.postgres = PostgreSQL()
        super(AddCourseStudent, self).__init__()

    def add_course_student(self):
        """
        This API is for Adding course students
        ---
        tags:
          - Course Student
        produces:
        ...
        parameters:
          ...
          - name: query
            in: body
            description: Add Course students
            required: true
            schema:
        ...
        data = {}
        data['message'] = "Students successfully added to a course"
        data['status'] = "ok"
