...
class StudentCourseExercise(Common):
    """Class for StudentCourseExercise"""

    # INITIALIZE
    def __init__(self):
        """The Constructor for StudentCourseExercise class"""
        self.postgresql_query = PostgreSQL()
        self.sha_security = ShaSecurity()
        self.questionnaires = Questions()
        self.unlock = Unlock()
        super(StudentCourseExercise, self).__init__()

    def course_exercise(self):
        """
        This API is for Getting Student Course Exercise Questionnaires
        ---
        tags:
          - Student Course
        produces:
        ...
        # end_time = time.time()
        # print("validate_course_requirements: {0}".format((end_time-strt_time)*1000.0))
        ...
        if result:
            ...
            for subsection_row in result['sections']:
                ...
                for exercises in subsection_row['subsection']:
                    ...
                    exercises['exercises'] = sorted(exercises['exercises'], key=lambda i: int(i['exercise_number']))
    ...
    #     sql_str = "SELECT * FROM student_exercise WHERE exercise_id"
